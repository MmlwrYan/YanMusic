...
const syncLyricEffectRootState = () => {
  ...
  if (lastEffectRootState.scrollIndex !== scrollIndex.value) {
    ...
    root.style.setProperty('--yan-lyric-scroll-index', String(scrollIndex.value));
  }
...
<template>
  <div
    ...
    class="lyric-scroller-wrap yan-lyric-effect-host"
    :class="lyricEffectClassName"
    data-yan-lyric-host="page"
  ...
  >
    <div
      ...
      data-yan-lyric-scroller="page"
      :data-yan-lyric-current-index="currentIndex"
      :data-yan-lyric-scroll-index="scrollIndex"
      ...
      <template v-if="hasLyrics">
        ...
        >
          <div
            ...
            data-yan-lyric-row
            :data-yan-lyric-index="entry.index"
            :data-yan-lyric-current="currentIndex === entry.index ? 'true' : 'false'"
            :data-yan-lyric-filtered="entry.filtered ? 'true' : 'false'"
            :data-yan-lyric-distance="entry.distance"
            :data-yan-lyric-abs-distance="entry.absDistance"
            :data-yan-lyric-scroll-distance="entry.scrollDistance"
            :style="{
              '--yan-lyric-index': String(entry.index),
              '--yan-lyric-line-start-ms': String(getLineStartMs(entry.line)),
              '--yan-lyric-distance': String(entry.distance),
              '--yan-lyric-abs-distance': String(entry.absDistance),
              '--yan-lyric-scroll-distance': String(entry.scrollDistance),
          ...
          >
            <div
              ...
              :data-yan-lyric-index="entry.index"
              :data-yan-lyric-current="currentIndex === entry.index ? 'true' : 'false'"
              :data-yan-lyric-scroll-highlight="
            ...
            >
              ...
              <template v-if="lyricStore.lyricsMode === 'both' && lyricStore.secondaryEnabled">
                <span
                  ...
                  data-yan-lyric-secondary
                  data-yan-lyric-secondary-kind="romanized"
                  :style="{
                ...
                <span
                  ...
                  class="lyric-subline mt-1 block max-w-full truncate"
                  data-yan-lyric-secondary
                  data-yan-lyric-secondary-kind="translated"
                  :style="{
                    fontSize: secondaryFontSize,
                    fontWeight: String(
                      currentIndex === entry.index
              ...
              <template v-else>
                <span
                  ...
                  class="lyric-subline mt-1 block max-w-full truncate"
                  data-yan-lyric-secondary
                  :data-yan-lyric-secondary-kind="lyricStore.lyricsMode"
                  :style="{
                    fontSize: secondaryFontSize,
                    fontWeight: String(
                      currentIndex === entry.index
      ...
      <template v-else-if="hasStaticLyrics">
        <div class="static-lyric-list">
          <div
            ...
            data-yan-lyric-static-row
            :data-yan-lyric-index="index"
            :style="{
    ...
    <div
      ...
      class="yan-lyric-effect-overlay"
...
.yan-lyric-effect-host {
  isolation: isolate;
  --yan-lyric-current-index: -1;
  --yan-lyric-scroll-index: -1;
  --yan-lyric-current-time: 0;
  --yan-lyric-timeline-ms: 0;
  --yan-lyric-playback-rate: 1;
}
