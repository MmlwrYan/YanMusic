...
import { iconArrowLeft, iconRefreshCw } from '@/icons';
import { iconHeadphones, iconLoader2 } from '@/utils/audioEffectIcons';
import Scrollbar from '@/components/ui/Scrollbar.vue';
import OnlineAudioEffectCard from '@/components/player/OnlineAudioEffectCard.vue';
