...
import { iconCurrentLocation, iconList, iconPlay, iconSearch } from '@/icons';
...
const iconShoppingBag = shoppingBag as IconifyIcon;

const PURCHASED_QUEUE_OPTIONS: SetPlaybackQueueOptions = {
