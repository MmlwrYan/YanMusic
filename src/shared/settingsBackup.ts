...
export const SETTINGS_BACKUP_FORMAT = 'yanmusic-settings-backup' as const;
export const SETTINGS_BACKUP_VERSION = 1 as const;
export const SETTINGS_BACKUP_EXTENSION = 'yanmusic-backup';
 ...
 */
const NON_PORTABLE_APP_SETTING_KEYS = new Set([
  'appVersion',
  'isPrerelease',
  'appIsPackaged',
  'outputDevice',
  ...
  'impulseResponseMix',
  'impulseResponseSafetyMigrationDone',
  'searchHistory',
